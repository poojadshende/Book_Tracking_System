                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <form role="form" action="../BookSearchController" method="post">
                                        
                                        <input type="hidden" name="book" value="request">
                                        <div class="form-group">
                                            <label>Book ID </label>
                                            <input class="form-control" placeholder="Enter text" name="bookid" id="bookid">
                                        </div>
                                        <div class="form-group">
                                            <label>Student Name </label>
                                            <input class="form-control" placeholder="Enter text" name="studentname" id="studentname">
                                        </div>
                                        <div class="form-group">
                                            <label>Student ID </label>
                                            <input class="form-control" placeholder="Enter text" name="studentid" id="studentid">
                                        </div>
